...
class ListBooks extends Component{
	static propTypes = {
  	...
  	render(){
  		const currentlyReadingBooks = this.props.books.filter(book => {return book.shelf === 'currentlyReading';});
    	const wantToReadBooks = this.props.books.filter(book => {return book.shelf === 'wantToRead';});
    	const readBooks = this.props.books.filter(book => {return book.shelf === 'read';});
    	return (
